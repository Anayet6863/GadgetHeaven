...
const Histories = () => {
  ...
  return (
    <div>
      ...
      <div className="text-5xl text-black p-10 container mx-auto flex">
        ...
        <div className="ml-auto flex gap-10">
         <button className="btn bg-red-600 text-white p-3 w-[150px] h-[52px]">Trendings</button>
    ...
    <p className="text-5xl font-bold text-red-400 text-center mb-20 mt-20">Sorry.Not purchased anything.</p>
) : (
    purchasedProduct.map((item, idx) => (
        <History key={idx} item={item} />
    ))
)}
